...
현재 Curtain은 **1.0.8 beta-r31**입니다.
...
> 위 버튼을 누른 뒤 **Assets**를 펼쳐 `Curtain-Setup-1.0.8-beta-r31.exe`를 내려받으세요.
...
2. 아래 **Assets**를 펼쳐 `Curtain-Setup-1.0.8-beta-r31.exe`를 내려받습니다.
