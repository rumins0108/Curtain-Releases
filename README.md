...
- **작품 만들기:** 작품 목록 옆 <strong>+</strong>에서 이름과 음원을 선택합니다. 전체 보유곡·작품 미지정·특정 작품/속폴더 필터와 검색을 함께 사용하며, 필터를 바꿔도 선택은 유지됩니다. 선택한 곡은 기존 작품·속폴더에서 새 작품으로 이동하며, 즐겨찾기와 재생 횟수 등 음원 정보는 유지됩니다.
...
1.0.14 beta-r1~r16의 변경을 통합했습니다. **같은 링크 음원관리**, **대표 이미지 선택과 재생위치 이동**, **MP3/MP4·일괄·백그라운드 다운로드**, **작품 생성 필터**, **가져오기 작품명 적용**, **가사/대본 높이 조절**이 포함됩니다. 사라진 작품을 같은 이름으로 만들 때 이전 이미지·설명·상단 고정이 다시 나타나던 문제와 로컬 파일 가져오기도 수정했습니다.

[1.0.15 beta 전체 업데이트 내역 →](https://github.com/rumins0108/Curtain-Releases/releases/tag/v1.0.15-beta)
...
[최신 릴리스](https://github.com/rumins0108/Curtain-Releases/releases/tag/v1.0.15-beta) · [전체 업데이트 기록](https://github.com/rumins0108/Curtain-Releases/releases)
