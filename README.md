...
- **구간 편집** — 로컬 미디어의 파형을 분석하거나 YouTube 영상 시간표를 등록해 구간 넘버 생성
- **원본 음원 이동** — 구간편집본의 상태 칸에서 원본을 찾아 전체 라이브러리에서 재생하거나 보관함에서 위치 확인
- **파일 연결·백업** — 로컬 파일 위치를 수정하고 라이브러리 상태를 점검하며 백업 생성·복원
